...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './recette.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECETTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_RECETTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RECETTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RECETTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RECETTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RECETTE actions', async () => {
      const expectedActions = [
        {
